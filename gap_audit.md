...
CFDrs PR #349 source head `3c163895` passes the focused local value-semantic
...
`06d237c5`, `463b4d68`, `7a7b4289`, and `3c163895` own the `cfd-core`
state/field-operation/GPU-kernel/validation/compute-dispatch/GPU-integration
test unwraps and GPU-test print classes, plus the `cfd-io` checkpoint
roundtrip diagnostics, without touching the peer Cargo.lock. Local formatting

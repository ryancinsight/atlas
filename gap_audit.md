...
CFDrs PR #349 source head `3cd393b6` passes the focused local value-semantic
...
`1d1e14c8`, `6b22c4bd`, and `3cd393b6` own the `cfd-core`
state/field-operation/GPU-kernel/validation/compute-dispatch/GPU-integration/
conversion/boundary/time-controller/error-context/blood-model test unwraps and

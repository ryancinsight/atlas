...
CFDrs PR #349 source head `6b22c4bd` passes the focused local value-semantic
...
`1d1e14c8`, and `6b22c4bd` own the `cfd-core`
state/field-operation/GPU-kernel/validation/compute-dispatch/GPU-integration/
conversion/boundary/time-controller/error-context test unwraps and

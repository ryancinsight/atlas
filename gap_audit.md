...
| **CR-4** | `[major]` | Rebase `coeus-core::Scalar` + `let''o-ops::Scalar` over `eunomia::{NumericElement, RealField}` as supertraits. | Source citations T1: `coeus/coeus-core/src/dtype/traits.rs:1-11` (Scalar redecl); `let''o/crates/leto-ops/src/domain/scalar.rs:1-21` (Scalar redecl); `eunomia/crates/eunomia/src/traits/{numeric,field}.rs:7-27` (SSOT); `atlas/docs/audit/2026-07-02-cross-repo-integration-audit.md`: (CR-4 [major] citation). | OPEN. Batch #7. |

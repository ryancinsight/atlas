...
- The next implementation order is: Kwavers transducer result contracts;
  CFDrs typed report carriers; then the Aequitas volumetric-energy-density
  extension and the dependent acoustic report. Helios image-quality API

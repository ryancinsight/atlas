...
CFDrs PR #349 source head `bebe2d55` passes the focused local value-semantic
...
`1d1e14c8`, `6b22c4bd`, `3cd393b6`, `ccf889c2`, `33cb9af4`, `3f8fe517`, and
`bebe2d55` own the `cfd-core`
...
unsupported-backend/cavitation/result-existence test assertions and

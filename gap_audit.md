...
- Kwavers PR #324’s prior heads `c739c7b38`, `61b2198f`, and `ae345de7c`
  ...
  refreshed. Current head `c25edb951` descends from `e52fee18f`, which reaches
...
- The grid-derived, thermal-diffusion, and basic-piston implementations are
  ...
  `c25edb951` preserves the provider graph verified at `e52fee18f`; the

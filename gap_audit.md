...
CFDrs PR #349 advanced from `bc39d336` through `c5563b9e`, `fe98c280`, and
`404594b0` to `05328639`.
...
next hosted PR run is `32117031666`, queued for Rust and book figures.

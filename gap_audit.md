...
CFDrs PR #349 source head `e57696e6` carries the bounded `cfd-core`/`cfd-math`
...
expectations and routing convergence diagnostics through tracing. Earlier
source cleanup
...
`3fbffc6a`, `7af3f9e7`, `3ebb5f77`, `8db668eb`, `5fe6e307`, and `e57696e6` own the
`cfd-core`/`cfd-math`

...
CFDrs PR #349 source head `1d1e14c8` passes the focused local value-semantic
...
`06d237c5`, `463b4d68`, `7a7b4289`, `3c163895`, `9b2ab34d`, `1389ce05`, and
`1d1e14c8` own the `cfd-core` state/field-operation/GPU-kernel/validation/
compute-dispatch/GPU-integration/conversion/boundary test unwraps and

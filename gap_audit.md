...
CFDrs PR #349 source head `8db668eb` carries the bounded `cfd-core`/`cfd-math`
...
singular-system assertion to match `Error::Solver`. Earlier source cleanup
...
`3fbffc6a`, `7af3f9e7`, `3ebb5f77`, and `8db668eb` own the `cfd-core`/`cfd-math`

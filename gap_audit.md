...
CFDrs PR #349 source head `5fe6e307` carries the bounded `cfd-core`/`cfd-math`
...
`Error::InvalidConfiguration` for empty levels. Earlier source cleanup
...
`3fbffc6a`, `7af3f9e7`, `3ebb5f77`, `8db668eb`, and `5fe6e307` own the
`cfd-core`/`cfd-math`

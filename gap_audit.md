...
- The current implementation state is: CFDrs' audited report carriers are
  ...
  cross-section/edge geometry in MET-12, and curved/micromixer geometry in
  MET-13; the remaining public CFDrs vascular/Womersley boundary is recorded
  in the child audit;

...
- **Delivered (PR [#590](https://github.com/ryancinsight/kwavers/pull/590), merged at default `ca5c9c93`):** the generator, typed stubs, and GIL-release + value-correctness oracles for `Simulation::run`, thermal, and bubble-ODE (Rayleigh-Plesset/Keller-Miksis/Gilmore/Hodgkin-Huxley) families.

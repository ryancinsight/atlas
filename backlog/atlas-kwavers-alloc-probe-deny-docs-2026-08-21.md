...
- **Delivered:** one-line addition on clean lane `fix/kwavers-alloc-probe-deny-docs` (commit `aa5ab2bc`); format, check, `-D warnings` clippy, nextest, doctests, rustdoc all pass locally.

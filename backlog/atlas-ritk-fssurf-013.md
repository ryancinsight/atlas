...
- next: the FreeSurfer `aseg`/Desikan `aparc` label table is hand-rolled in a downstream consumer at `repos/leoneuro-rs/crates/leoneuro-gui/src/freesurfer.rs` (137 lines) — the RITK owner's first increment deletes it and repoints that consumer.

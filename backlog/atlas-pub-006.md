...
- **Delivered:** hephaestus facade landed (`bf24b87`, verified on all four feature configurations). First unblocker-chain link merged across proteus/CFDrs/hyperion/kwavers/helios (renames only; `cargo publish` of `proteus-mat` — release authority — still pending).

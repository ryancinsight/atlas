...
delivered: `ares-athena`→`ares-operator`, `ares-harmonia`→`ares-coupling` (ADR 0001 carries a dated revision note; architecture test, fixtures, stack diagram, and board moved with it). Full ares gate green.

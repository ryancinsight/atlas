...
- [ ] Complete `ATLAS-CFDRS-BACKWARD-STEP-108`: finish hosted verification and
      integrate provider PR #349 at current exact source head `06d237c5`.
      ...
      benchmark contract.
- [x] Push the bounded `cfd-core` lint cleanup at `22d74042`, `c70d44e3`, and
      `06d237c5`: replace state, field-operation, and GPU-kernel test unwraps
      with invariant-bearing expectations and route GPU-unavailable diagnostics
      through tracing. Formatting and touched-source residue scans pass locally;
      the locked package compile is overlay-blocked and the peer Cargo.lock

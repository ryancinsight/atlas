...
- [ ] Complete `ATLAS-CFDRS-BACKWARD-STEP-108`: finish hosted verification and
      integrate provider PR #349 at current exact source head `e0e3e123`.
      ...
      benchmark contract.
- [x] Push the bounded CFDrs lint cleanup through `e0e3e123`: replace state,
      ...
      multigrid coarsening test family.

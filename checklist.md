...
- [ ] Keep the remaining peer PR blockers explicit: CFDrs #333 is `CONFLICTING` at `3b2fffaa` with only its Hermes revision pin verified; RITK #144 closed unmerged with one macOS Kabsch/SVD rank-deficiency test failure at its final head; and RITK #154 is a 405-file conflicting change with no hosted checks. These are not merge or source-closure evidence for Atlas.

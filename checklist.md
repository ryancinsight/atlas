...
- **ATLAS-MOIRAI-ORDERING-052-POOL** Moirai connection-pool reservation ordering slice — claimed for `moirai-async/src/net/types.rs`; add a bounded admission/cancellation Loom model before reducing the three `reserved_connections` update orderings

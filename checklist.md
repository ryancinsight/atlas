...
- **ATLAS-MOIRAI-ORDERING-052-WAKER** Moirai async executor wake-dedup ordering slice — claimed for `moirai-async` `is_queued` protocol model and justified Relaxed demotion; completion guard and scheduler protocols excluded

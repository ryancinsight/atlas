...
- [ ] Complete `ATLAS-CFDRS-BACKWARD-STEP-108`: finish hosted verification and
      integrate provider PR #349 at current exact source head `003eae73`.
      ...
      benchmark contract.
- [x] Push the bounded CFDrs lint cleanup through `003eae73`: replace state,
      ...
      restriction, and smoother test families.

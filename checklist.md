...
- [ ] Complete `ATLAS-CFDRS-BACKWARD-STEP-108`: finish hosted verification and
      integrate provider PR #349 at current exact source head `bd2dec30`.
      ...
      benchmark contract.
- [x] Push the bounded CFDrs lint cleanup through `bd2dec30`: replace state,
      ...
      multigrid coarsening, DG limiter, GMG, and SIMD test families.

...
- [ ] Complete `ATLAS-CFDRS-BACKWARD-STEP-108`: finish hosted verification and
      integrate provider PR #349 at current exact source head `bebe2d55`.
      ...
      benchmark contract.
- [x] Push the bounded CFDrs lint cleanup through `bebe2d55`: replace state,
      field-operation, GPU-kernel, compute-dispatch, GPU-integration,
      conversion, boundary, time-controller, error-context, blood-model,
      plugin, unsupported-backend, cavitation, and result-existence assertions

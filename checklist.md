...
- **ATLAS-ADR-GOV-058-RITK** Ritk ADR-index slice — claimed for `repos/ritk/docs/adr`; normalize only the three reported status anomalies and regenerate the Ritk derived index

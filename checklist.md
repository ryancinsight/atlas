...
- **ATLAS-MOIRAI-ORDERING-052-REACTOR** Moirai PAL reactor ordering slice — claimed for `moirai-pal/src/reactor/core.rs`; audit the loop-control flag and preserve the independent platform wake path

...
| <a id="ADR-0039"></a>**0039** | Compute-substrate topology across Apollo, Leto, Hephaestus, and Coeus — Hephaestus owns the vendor dimension and no consumer re-forks it (`coeus-rocm`/`coeus-metal` are 1 185 of 1 247 lines identical modulo the vendor token, forced by Hephaestus's free-function surface); seam coverage precedes consumer collapse; the 14-entry-point Leto/Hephaestus decomposition pair gets one role trait and one differential oracle; Apollo's 19-of-23 repeated plan/execution scaffold consolidates behind a generic layer | Proposed | 2026-07-28 | `[arch]` | coeus / hephaestus / leto / apollo / atlas-meta | gpu-substrate |

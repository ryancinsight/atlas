...
## ATLAS-TOOLCHAIN-COHERENCE-001 — One compiler identity across the shared cache [patch] — todo
...
- Acceptance: `rustc -V` under every member and tool matches its pin; a full-stack build produces no E0514; the preflight check is green in the sweep.
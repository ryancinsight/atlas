...
- **Current slice:** Helios PR #59 carries the caller-side `mdbook test`
  ...
  at exact head `e5d4ac74`; the preceding Rust run failed before checkout on a
  ...
  source-correctness heads were superseded by `e5d4ac74`; new exact-head CI
  and Pages runs `32044669677` and `32044669877` are queued.
...
- First bounded slice delivered locally on provider branch
  `codex/cfdrs-runtime-budget` at source commit `e5d4ac74` (PR #347): cfd-2d
  ...
  `e5d4ac74`; exact-head runs `32044669677` and `32044669877` are queued.

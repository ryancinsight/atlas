...
VNNI packer and follow-up lint/docs cleanup at `e4de166`; local contract gates
are green, and hosted run 31774000496 is pending. The prior benchmark and Intel
SDE AMX differential checks are green; x86 previously stopped at the unchanged
345-error HS-435 core Clippy debt. The seven listed pointers remain peer-owned
and are not rewritten by this audit.

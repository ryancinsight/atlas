...
| ATLAS-ADR-GOV-058-HORAE | Horae ADR index refresh is scoped for the current clean merged default; its ADR header is already canonical and only generated-index drift is in scope. |

...
<a id="atlas-pm-artifact-budgets"></a>- [ATLAS-PM-ARTIFACT-BUDGETS](backlog/atlas-pm-artifact-budgets.md) — The stack PM artifacts are eight to sixteen times their budget [patch] — in-progress
<a id="atlas-run-output-segregation"></a>- [ATLAS-RUN-OUTPUT-SEGREGATION](backlog/atlas-run-output-segregation.md) — Two output roots at the stack root, one of them tracked-visible [patch] — todo

...
lint/docs/structure cleanup at `5d296d7`; local contract gates are green, and
hosted run 31779350672 is running against that exact head. Its x86 format and
Clippy steps are green; the remaining jobs are active. The prior benchmark and

...
- **Current slice:** Helios PR #59 carries the caller-side `mdbook test`
  ...
  at exact head `8f08112b`; the preceding Rust run failed before checkout on a
  ...
  `32044071453` and `32044071732` were infrastructure-red. The PM-only head
  `8f08112b` has new exact-head CI and Pages runs `32044417360` and
  `32044417578` queued.
...
- First bounded slice delivered locally on provider branch
  `codex/cfdrs-runtime-budget` at source commit `8f08112b` (PR #347): cfd-2d
  ...
  infrastructure-red. PM-only head `8f08112b` has exact-head runs
  `32044417360` and `32044417578` queued.

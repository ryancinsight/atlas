...
| US-023-D2 | Block-matching follow-ons: multi-resolution search-region sources and block-radius calculators, FFT-accelerated NCC, Bayesian-regularized and strain-window displacement calculators, and an end-to-end pipeline over a block grid. | [minor] | **done 2026-08-19** — ritk PR #187 merged at `40618f84`; track_volume(), BlockGrid, DisplacementField, strain_from_displacement() | Claude | track_volume recovers known shift; strain recovers 2% compression exactly; 14/14 tests pass |

...
lint/docs/structure cleanup at `5a8d718`; local contract gates are green, and
hosted run 31779776851 is queued against that exact head. The predecessor's
x86 format and Clippy steps were green; the new exact-head run is required
before closure. The prior benchmark and

...
- **Sweep opened (2026-09-02, `--bump-pin`, pin `191617bf`):** aequitas#46 (proved the mode: pin moved, header regenerated, index body unchanged), apollo#280, asclepius#35, athena#25, coeus#357, eunomia#80, gaia#40, harmonia#14, hephaestus#254, hermes#137, horae#34, hyperion#31, iris#25, kwavers#693, leto#148, melinoe#27, mnemosyne#109, moirai#241, proteus#27, ritk#216, themis#43, tyche#43 — every member with ADRs except helios (its guard PR #81 is still open) and consus (#62 landed after the sweep started; both follow). Gate: each PR's own `ADR index is current` check.
